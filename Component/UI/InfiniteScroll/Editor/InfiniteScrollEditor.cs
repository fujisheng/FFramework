...
namespace Framework.Component.UI.Editor
{
    ...
    public class InfiniteScrollEditor : ScrollRectEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            layoutType.intValue = (int)(InfiniteScroll.ItemLayoutType)EditorGUILayout.EnumPopup("layoutType", (InfiniteScroll.ItemLayoutType)layoutType.intValue);
        ...
        [MenuItem("GameObject/UI/InfiniteScroll", false, 90)]
