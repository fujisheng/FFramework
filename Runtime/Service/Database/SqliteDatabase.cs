    ...
    public class SqliteDatabase : IDatabase
    {
        ...
        public SqliteDatabase(string dbName, string path = null)
        {
            ...
            if (!File.Exists(completePath) )//&& File.Exists(streamingPath))
            {
                ...
                UnityEngine.Debug.Log($"writeAllBytes=>{request.downloadHandler.data.Length}");
                request.Dispose();
            }
#endif
        ...
        public void Connect()
        {
            try
            {
                connection = new SqliteConnection(connectionPath);
                connection.Open();
                UnityEngine.Debug.Log($"Connected {connectionPath}");
            }
            catch (Exception ex)
            {
        ...
        public void Disconnect()
        {
            ...
            UnityEngine.Debug.Log($"Disconnection  {connectionPath}");
        }
        ...
        public IDataReader Execute(IQuery query)
        {
            ...
            {
                UnityEngine.Debug.Log($"ExecuteQueryError:{ex}");
                return null;
            }
        }
        ...
        public IDataReader Execute(string queryString)
        {
            ...
            {
                UnityEngine.Debug.Log($"ExecuteQueryError:{queryString}:{ex}");
                return null;
            }
        }
        ...
        public void ClearTables()
        {
            ...
            Dictionary<int, Dictionary<string, object>> dic = Utility.DataReader.ReaderToDictionarys(dataReader);
