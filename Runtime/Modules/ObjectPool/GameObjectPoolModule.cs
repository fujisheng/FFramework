...
namespace Framework.Module.ObjectPool
{
    ...
    internal sealed class GameObjectPoolModule : Module, IGameObjectPoolModule
    {
        ...
        public async ValueTask<GameObject> Pop(string gameObjectName)
        {
            if (pools.ContainsKey(gameObjectName))
            {
