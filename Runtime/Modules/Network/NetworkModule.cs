using Framework.IoC;
using Framework.Module.Threading;
using System;

namespace Framework.Module.Network
{
    [Dependencies(typeof(IThreadModule))]
    internal sealed class NetworkModule : Module, INetworkModule
    {
        ...
        void OnConnectionSuccessful(IAsyncResult result)
        {
            ...
            ModuleManager.Get<IThreadModule>().QueueOnMainThread(() =>
            {
