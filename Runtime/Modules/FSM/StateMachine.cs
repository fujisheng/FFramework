...
{
    internal sealed class StateMachine<T> : StateMachineBase, IStateMachine<T> where T : class
    {
        ...
        public StateMachine(string name, T owner, params IState<T>[] states) : base(name)
        {
